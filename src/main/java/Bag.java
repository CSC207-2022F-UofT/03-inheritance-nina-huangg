...
public abstract class Bag {
     ...
     *
     * @return the last item added to this bag or null if there are no items.
     */
    public String popItem(){
        if (this.numberOfContents == 0){
            ...
            String itemRemoved;
            itemRemoved = this.contents.get(this.numberOfContents-1);
            this.numberOfContents -= 1;
     ...
     *
     * @return a String containing details of the bag.
     */
    @Override
